...
export const editableRootStyle = {
  ...
  '--slot4-page-text': '#18272d',
  '--slot4-panel-bg': '#f2f1ec',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#68767a',
  '--slot4-soft-muted-text': '#999999',
  '--slot4-accent': '#7FB77E',
  '--slot4-accent-fill': '#2F6B3F',
  '--slot4-accent-soft': '#dfeedd',
  '--slot4-on-accent': '#ffffff',
  '--slot4-dark-bg': '#2F6B3F',
  ...
  '--editable-page-bg': '#fffdf9',
  '--editable-page-text': '#18272d',
  '--editable-container': '1440px',
  '--editable-border': '#dcdedb',
  '--editable-nav-bg': '#ffffff',
  '--editable-nav-text': '#18272d',
  '--editable-nav-active': '#2F6B3F',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#2F6B3F',
  '--editable-cta-text': '#ffffff',
  '--editable-search-bg': '#ffffff',
  '--editable-footer-bg': '#2F6B3F',
